  ...
  return (
    <div className='flex h-[2.5rem] shrink-0 items-center'>
      <div className='flex items-start gap-[0.25rem]'>
        <div
          data-속성-1='comp chip'
          className='flex items-center gap-[0.25rem] rounded-xl bg-blue-50 px-[0.75rem] py-[0.375rem]'
        >
        ...
        <div
          data-속성-1='job chip'
          className='flex items-center gap-[0.25rem] rounded-xl bg-gray-50 px-[0.75rem] py-[0.375rem]'
        >
