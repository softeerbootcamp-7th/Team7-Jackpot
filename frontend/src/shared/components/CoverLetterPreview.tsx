...
const CoverLetterPreview = ({
  ...
  return (
    <Link
      ...
      className={`focusable-card ${isCoverLetter ? 'h-[11.25rem]' : ''} flex flex-1 cursor-pointer items-center justify-start gap-9 rounded-2xl py-6 pr-6 pl-9 outline outline-1 outline-offset-[-1px] outline-gray-100`}
    >
